...
\begin{wrapfigure}{l}{0.4\textwidth}
  \begin{center}
      \vspace{-0.4cm}
    \includegraphics[width=0.38\textwidth]{dedalus_massive_star.png}
      \vspace{-0.6cm}
  \end{center}
    \caption{A simulation I ran in \emph{Dedalus} of a 40 $M_{\odot}$ star. The entropy field is visualized; red is hot and buoyantly rises, blue is cold and falls. We see a convective core with a strong dipole flow and an outer radiative envelope with internal gravity waves. \label{fig:star}}
    \vspace{-1cm}
\end{wrapfigure}


To understand the fluid dynamical picture behind CBM, my group will create simulations of massive stars like the one in Fig.~\ref{fig:star} using the open source \emph{Dedalus} \citep{burns_etal_2020} code.
These simulations will differ from past simulations of massive stars, because they will include the full ``ball'' geometry of the convective core, they will employ the fully compressible equations without any luminosity boosting, and they will be relaxed into thermal equilibrium.
%\footnote{See \url{https://vimeo.com/483598178} for a preliminary example of one of these simulations.}.
...
My research group will develop simulations with efficient, reduced models of RT to create a simulation suite spanning stars on the lower main sequence and create synthesized observables to compare with existing CBS datasets.
...
\textbf{\underline{\emph{Deliverable:}} The first constraint from 3D simulations on convective blueshift spanning stars along the lower main sequence.}
...
Open science is very important to me; my group will employ best-coding-practices and upload our simulation code and run scripts to GitHub and Zenodo so that our science can be easily reproduced.
