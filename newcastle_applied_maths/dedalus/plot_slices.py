...
Options:
    --fig_name=<fig_name>               Name of figure output directory & base name of saved figures [default: movie]
...
plotter = SlicePlotter(root_dir, file_dir='snapshots', out_name=fig_name, start_file=start_file, n_files=n_files)
...
if int(args['--fig_type']) == 1:
    ...
    fnames = [  (('tracer',),         {'cmap': 'Greens', 'vmin': 0, 'vmax': 1})]
